...
/**
 * shash_table_set - function that add an element to the sorted hash table
 * @ht: pointer to sorted hash table
...
/**
 * shash_table_print_rev - function that print the key:value from ht in reverse
 * @ht: pointer to hash table
 *
 */
...
/**
 * shash_table_delete - free hash table and other nodes
 * @ht: pointer to hash table
 *
 */
